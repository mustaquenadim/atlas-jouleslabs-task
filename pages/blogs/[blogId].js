...
export default function BlogDetails() {
  ...
  return (
    <div className='px-24'>
      <div className='overflow-hidden border dark:border-gray-900 p-4'>
        <h3 className='font-bold text-xl dark:text-gray-300 mb-2 line-clamp-2'>{posts?.title}</h3>
        ...
        <div className='px-1 py-4'>
          <p className='text-gray-500 text-base line-clamp-2'>{posts?.body}</p>
        </div>
